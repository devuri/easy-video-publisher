...
= Do I need YouTube API key =

An API key is not required for single video import, you can simply use as-is, to Import multiple videos from a specified channel a valid YouTube API key is required.
